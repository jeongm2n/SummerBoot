    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
            <div class="container">
                <div class="row p-5">
                    <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                        <img class="img-fluid" src="./assets/img/04.jpg" alt="">
                    </div>
                    <div class="col-lg-6 mb-0 d-flex align-items-center">
                        <div class="text-align-left">
...
<section class="container py-5">
    <div class="row text-center pt-3 justify-content-center">
        <div class="col-12 col-md-4 p-5 mt-3">
            <a href="#"><img src="./assets/img/05.jpg" class="rounded-circle img-fluid border"></a>
            <h5 class="text-center mt-3 mb-3"><b>외부세차</b></h5>
            <p class="text-center"><a class="btn btn-washboot">가이드</a></p>
        </div>
        <div class="col-12 col-md-4 p-5 mt-3">
            <a href="#"><img src="./assets/img/06.jpg" class="rounded-circle img-fluid border"></a>
